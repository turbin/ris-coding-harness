...
test -f "$TMP/new/.agents/skills/rsi-loop/SKILL.md"
test -f "$TMP/new/.agents/skills/min-loop/SKILL.md"
test -f "$TMP/new/.agents/skills/rsi-loop/references/preflight.md"
...
test -f "$TMP/existing/.agents/skills/rsi-loop/SKILL.md"
test -f "$TMP/existing/.agents/skills/min-loop/SKILL.md"
...
test -f "$TMP/multi/.agents/skills/rsi-loop/SKILL.md"
test -f "$TMP/multi/.agents/skills/min-loop/SKILL.md"
test -f "$TMP/multi/.claude/skills/pm-workers-engineering/SKILL.md"
test -f "$TMP/multi/.claude/skills/rsi-loop/SKILL.md"
test -f "$TMP/multi/.claude/skills/min-loop/SKILL.md"
